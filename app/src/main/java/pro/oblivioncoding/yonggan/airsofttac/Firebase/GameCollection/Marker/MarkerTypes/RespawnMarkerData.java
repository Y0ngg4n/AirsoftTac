...
public class RespawnMarkerData extends MarkerType {

    private boolean own;

    public RespawnMarkerData(){}

    public RespawnMarkerData(final double latitude, final double longitude, final String title, final String description, final boolean own) {
